...
const TrueFocus = ({
  ...
  useEffect(() => {
    if (currentIndex === -1 || !wordRefs.current[currentIndex] || !containerRef.current) return;
  ...
  return (
    ...
    >
      ...
      >
        <span
          className="absolute left-[-10px] top-[-10px] h-4 w-4 rounded-[3px] border-[3px] border-r-0 border-b-0"
          style={{
        ...
        ></span>
        <span
          className="absolute right-[-10px] top-[-10px] h-4 w-4 rounded-[3px] border-[3px] border-l-0 border-b-0"
          style={{
            borderColor: 'var(--border-color)',
            filter: 'drop-shadow(0 0 4px var(--border-color))',
          }}
